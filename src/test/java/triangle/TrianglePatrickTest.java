...
public class TrianglePatrickTest {
				
				public static final Triangle triangle = new TrianglePatrick();
				...
				@Test
				public void testGetTriangleResultForLengthsEquiliteral3() {
				...
				@Test
				public void testGetTriangleResultForLengthsEquiliteral4() {
				...
				@Test
				public void testGetTriangleResultForLengthsEquiliteral5() {
				...
				@Test
				public void testGetTriangleResultForLengthsEquiliteral6() {
								final int[] input = { 80, 50, 80, 80 };
								final TriangleResult expected = TriangleResult.UNKNOWN;
								final TriangleResult result = triangle.getTriangleResultForLengths(input);
								assertThat(result).isEqualTo(expected);
				}
				...
				@Test
				public void testGetTriangleResultForLengthsEquiliteral7() {
								final int[] input = { 80, 50 };
								final TriangleResult expected = TriangleResult.UNKNOWN;
								final TriangleResult result = triangle.getTriangleResultForLengths(input);
								assertThat(result).isEqualTo(expected);
				}
